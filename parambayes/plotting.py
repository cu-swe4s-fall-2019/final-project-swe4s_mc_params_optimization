...
def create_param_triangle_plot_4D(trace, tracename, lit_values,
    ...
    if np.shape(trace) != (0,):
        ...
        '''
        axs[0,0].axvline(x=eps_prior[0],color='r',
        ...
        '''
        axs[0,1].scatter(lit_values[::4,2],lit_values[::4,1],color='0.25',marker='o',alpha=0.5,facecolors='none',
                         label='Pareto Values')
        ...
        axs[0,1].hist2d(trace[:,2],trace[:,1],bins=100,
                        cmap='cool',label='RJMC Sampling')
